        ...
        if (jsonObjArray != null) {
            ...
            for (int i = 0; i < jsonObjArray.size(); i++) {
                ...
                if (dates.equals(tempDate)) {
                    //counts nr of closed/opened review in a specific date
                    ...
                    //dates and opened and closed in an array
                } else {//sets new date and sums and reset nr of open/closed for the day before
